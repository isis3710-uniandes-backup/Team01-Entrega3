            ...
            <div className="container">
                <div className="row h-100 fullHeight"  >
                    <div className="col-6 d-flex align-content-center flex-wrap">
                        ...
                        {(this.state.logged === -1 || this.state.logged === false) ? <a className="btn btn-spoventPrincipal text-right" href="/login">Empecemos</a> : <Link className="btn btn-spoventPrincipal text-right" to={{
                            pathname: "/main",
                            state: {
                                user: this.state.logged
                            }
                        }}>Continuemos</Link>}
                    </div>
                    <div className="col-6 d-flex align-content-center flex-wrap">
